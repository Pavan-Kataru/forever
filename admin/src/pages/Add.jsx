...
const Add = ({token}) => {
  ...
  const onSubminHandler = async (e) =>{
    ...
    try{
        ...
        //&& operator below accepts image we uploaded if not all images it won't show any error it only takes how many we uploaded
  ...
  return (
    <form onSubmit={onSubminHandler} className="flex flex-col w-full items-start gap-3">
      <div>
