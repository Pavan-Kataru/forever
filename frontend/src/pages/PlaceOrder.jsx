           ...
           <div className='mt-8 min-w-80'>
            ...
            <div className='mt-12'>
                ...
                <div className='flex gap-3 flex-col lg:flex-row'>
                    ...
                    <div onClick={()=>{ toast.info('Razorpay is currently not working. Please select another payment method.');}} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
